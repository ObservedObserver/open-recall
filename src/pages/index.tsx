            ...
            <main className="mx-auto container lg:px-28">
                ...
                <div className="flex items-center justify-center mt-12 p-2">
                    <Link href="/play">
                        <button
                            type="button"
                            className="w-36 lg:w-64 justify-center inline-flex items-center rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-6 py-3 text-base font-medium text-white"
                        >
                            Start
                ...
                <div className="flex items-center justify-center mt-6 p-2">
                    <Link href="/history">
                        ...
                        >
                            History
                            <ClockIcon className="ml-3 -mr-1 h-5 w-5" aria-hidden="true" />
                        </button>
                    </Link>
                </div>
                <div className="flex items-center justify-center mt-6 p-2">
                    <Link href="https://github.com/ObservedObserver/open-recall">
                        <button
                            type="button"
                            className="w-36 lg:w-64 justify-center inline-flex items-center rounded-full border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                            Github
                            {/* <PlayIcon className="ml-3 -mr-1 h-5 w-5" aria-hidden="true" /> */}
